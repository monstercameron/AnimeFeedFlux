...
var esGenerateMessages = gwci18n.NamespaceCatalog{
	...
	"generate.editor.promptVariablesHint":       {Text: "Abajo se listan las variables disponibles en los prompts."},
	...
	"generate.workbench.modelDefault": {Text: "Modelo predeterminado"},
	...
	"generate.workbench.feedsSummary":   {Text: "Feeds ({arg1}): estado, programación, gasto, eliminar"},
	"generate.workbench.recipeSettings": {Text: "Ajustes de la receta: slug, programación, presupuestos, ventana, fuentes"},
